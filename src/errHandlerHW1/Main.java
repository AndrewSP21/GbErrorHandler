...
//        System.out.println(existingArrayElement(new int[]{1,2,3},5));
//        String text0 = "Иду на таран";
//        String text = "Время перемен";
//        System.out.println(eis(text0));
//        System.out.println(eis(text));
        int[] fArr = {1, 2, 5, 3};
        int[] sArr = {4, 2, 2, 6};
        int[] dArr = {2, 5, 7};
        int[] d2Arr = {2, 0, 5, 0};
